...
modlist = []
basePath = os.path.realpath(__file__)[:-16] + ".."
copyDirs = ["/scripts", "/resources", "/config", "/mods"]
serverCopyDirs = ["/scripts", "/config"]
modURLlist = []
...
shutil.copytree(basePath + "/buildOut/client/overrides/mods/",
                basePath + "/buildOut/server/mods/")
